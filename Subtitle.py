...
class Subtitle2(object):
    ...
    def get_init_time_milis(self):
        ...
        return self.buffer_frames[index].get_init_time_milis()

    def get_end_time_milis(self):
        """ get end time milis"""
        index = self.index_time
        return self.buffer_frames[index].get_end_time_milis()
    ...
    def next_frame_time(self):
        ...
        if self.index_time < self.num_frames:
            init_time = self.get_init_time_milis()
            end_time = self.get_end_time_milis()
            self.index_time += 1
            return init_time, end_time
        return None, None
    ...
    def get_init_time(self):
        ...
        end_time = self.buffer_frames[0].get_end_time_milis()
        self.index_time = 1
        return init_time, end_time
...
if __name__ == '__main__':
    ...
    # proceso para convertir subtitulos
    # convert = ConvertSrt()
